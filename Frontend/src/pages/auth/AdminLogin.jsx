...
export default function AdminLogin() {
	...
	return (
		<div className="min-h-screen bg-[#0A0A0D] flex items-start sm:items-center justify-center px-4 py-10 relative overflow-x-hidden">
			<div className="absolute inset-0 bg-linear-to-br from-slate-900/40 via-[#0A0A0D] to-violet-900/20" />

			<div className="absolute top-20 left-10 w-56 h-56 bg-slate-600/20 rounded-full blur-[120px]" />
			<div className="absolute bottom-20 right-10 w-56 h-56 bg-violet-600/20 rounded-full blur-[120px]" />
			...
			<div className="relative z-10 w-full max-w-md bg-[#111118]/95 backdrop-blur-xl border border-violet-500/20 rounded-3xl p-7 shadow-2xl shadow-violet-900/30">
				<div className="w-11 h-11 rounded-full bg-violet-500/15 border border-violet-400/30 flex items-center justify-center">
					<ShieldCheck size={20} className="text-violet-300" />
				</div>

				<h1 className="mt-5 text-3xl font-bold text-white">Admin Login</h1>
